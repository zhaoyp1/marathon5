...
public class TestProductSpecificationDate {
	...
	public static Object[][] one_charData = {
		{"processor(处理器)",false,true,new TimePeriod("2015-02-03 12:00:00", "2015-07-21 23:59:59"),true,new int[]{0},"cpu","unique",1,1,true,"CPU"},
		{"memory",false,true,new TimePeriod("2015-02-03 12:00:00", "2015-07-21 23:59:59"),true,new int[]{0},"memory","unique",1,1,true,"memory"},

	};
	//使用特征值
	public static Object[][] two_charData = {
		{"processor(处理器)",false,true,new TimePeriod("2015-02-03 12:00:00", "2015-07-21 23:59:59"),true,new int[]{1},"cpu","unique",1,1,true,"CPU"},
		{"memory",false,true,new TimePeriod("2015-02-03 12:00:00", "2015-07-21 23:59:59"),true,new int[]{1},"memory","unique",1,1,true,"memory"}
		};
