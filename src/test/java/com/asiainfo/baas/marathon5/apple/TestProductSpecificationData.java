...
public class TestProductSpecificationData {
    ...
    public static Object[][] specChar = {
            { "1", "processor(处理器)", "number", new TimePeriod("2015-02-03 12:00:00", "2015-07-21 23:59:59"), "unique",
                    1, 1 },
    ...
    public static Object[][] one_charData = {
            { "processor(处理器)", false, true, new TimePeriod("2015-02-03 12:00:00", "2015-07-21 23:59:59"), true,
