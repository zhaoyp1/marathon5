...
public class ProductSpecificationTest2 {
    ...
    public void initSpecCharValue() {
        prodSpec = new AtomicProductSpecification("AC001", "AppleCare For iPhone", "AppleCare",
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { false, "两个不相同规格对象比较", "mac-13", "13-inch MacBook Pro", "apple",
                        ProductSpecificationStatus.PLANNED.getValue() },
                { true, "两个相同规格对象比较", "AC001", "AppleCare For iPhone", "AppleCare",
                        ProductSpecificationStatus.PLANNED.getValue() } });
    }

    public ProductSpecificationTest2(boolean retFlag, String retMsg, String productNumber, String name, String brand,
