...
public class ProductSpecCharacteristicTest2 {
		...
		public ProductSpecCharacteristicTest2(boolean retFlag,String retMsg,String id,String name,String valueType,TimePeriod validFor,String unique,int minCardinality,int maxCardinality){
